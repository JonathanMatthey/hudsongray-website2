...
FancyUpload3.Attach.File = new Class({
	...
	render: function() {
		...
		var progress = new Element('img', {'class': 'file-progress', src: CKEDITOR.basePath+'plugins/image_uploader/fancy/bar.gif'}).inject(this.ui.size, 'after');
		this.ui.progress = new Fx.ProgressBar(progress, {
			fit: true,
			src: CKEDITOR.basePath+'plugins/image_uploader/fancy/progress.gif'
		}).set(0);
